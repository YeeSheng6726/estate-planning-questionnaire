    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-[#1e3a5f]/5 to-[#c9a962]/5 p-4 rounded-lg mb-6">
        ...
        <p className="text-xs text-gray-500 mt-1">
          List all properties you own. Maximum 5 properties.
          <span className="text-[#c9a962] ml-1">请列出您拥有的所有房产，最多5处。</span>
        </p>
      </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Select
                  ...
                  error={errors.realEstate?.[index]?.propertyType?.message}
              ...
              <Input
                ...
                error={errors.realEstate?.[index]?.address?.message}
              ...
              <Input
                ...
                error={errors.realEstate?.[index]?.mainBeneficiaries?.message}
              ...
              <Checkbox
                ...
                labelCn="已有房贷保险覆盖"
                checked={properties[index]?.hasMortgageInsurance}
