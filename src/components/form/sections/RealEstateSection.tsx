            ...
            <div className="space-y-4">
              ...
              {!property.isNotApplicable && (
                <>
                  ...
                  <Checkbox
                    label="Mortgage is fully settled"
                    labelCn="房贷已全额还清"
                    checked={property.isMortgageFullySettled}
                    onChange={(checked) => setValue(`realEstate.${index}.isMortgageFullySettled`, checked)}
                  />
                </>
              )}
            </div>
